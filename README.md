...
* Libraries & Frameworks: `Ruby on Rails`, `Node.js`, `Express.js`, `React`, `Redux`, `Bootstrap`, `Tailwind CSS`, `SASS`, `SCSS`, `Mongoose`, `Next.js`, `React Testing Library`,
* Databases: `PostgreSQL`, `MySQL`, `MongoDB`
* Technologies & Other: `Git`, `AWS`, `Docker`, `Heroku`, `REST API Development`, `TDD`, `BDD`, `RSpec`, `Capybara`, `Jest`
